...
export function Header() {
  return (
    <div className="w-full sm:flex justify-center  top-[-30px] z-50  ">
    <header className="px-28  h-32" >
      <nav className="w-full ">
        <div className="relative z-50 flex p-0 space-x-96  sm:space-x-0">
          <img className="w-40 h-40 animate-spin sm:w-[150px] sm:h-full " src={Logo} />
